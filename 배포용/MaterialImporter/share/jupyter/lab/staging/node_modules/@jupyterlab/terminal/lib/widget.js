...
(function (Private) {
    ...
    Private.inheritTheme = () => ({
        foreground: getComputedStyle(document.body).getPropertyValue('--jp-ui-font-color0'),
        background: getComputedStyle(document.body).getPropertyValue('--jp-layout-color0'),
        cursor: getComputedStyle(document.body).getPropertyValue('--jp-ui-font-color1'),
        cursorAccent: getComputedStyle(document.body).getPropertyValue('--jp-ui-inverse-font-color0'),
        selection: getComputedStyle(document.body).getPropertyValue('--jp-ui-font-color3')
    });
